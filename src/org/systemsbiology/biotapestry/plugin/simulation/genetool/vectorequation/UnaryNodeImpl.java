...
public class UnaryNodeImpl implements VectorEquationNode {
	private VectorEquationNode childNode_;
	
	public UnaryNodeImpl(VectorEquationNode child) {
		childNode_ = child;
	}
	
	public VectorEquationNode getChild() {
		return childNode_;
	}
